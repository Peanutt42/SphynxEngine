...
namespace Sphynx {
	...
	static void CrashReporterGUIRun() {
		...
		io.FontDefault = io.Fonts->AddFontFromFileTTF("Programs/CrashReporter/Fonts/OpenSans/static/OpenSans-Regular.ttf", 18.f);
		io.IniFilename = "Programs/CrashReporter/imgui.ini";
