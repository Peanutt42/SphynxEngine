...
namespace Sphynx::ReflectionGenerator {
	bool CachedReflectionInfo::Serialize(const std::filesystem::path& filepath, const std::vector<ComponentReflectionInfo>& components, const std::vector<std::filesystem::path>& filepaths, const std::filesystem::path& srcDir) {
		YAML::Emitter out;
		out << YAML::BeginMap;
	...
	bool CachedReflectionInfo::LoadUnchanged(const std::filesystem::path& filepath, const std::filesystem::path& srcDir, std::vector<std::filesystem::path>& outSrcFilepaths, std::vector<ComponentReflectionInfo>& outComponents, std::vector<std::filesystem::path>& outChangedFilepaths) {
