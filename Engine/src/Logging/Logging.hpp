...
#define SE_TRACE(category, msg, ...)			Sphynx::Logging::Log(Sphynx::Logging::Verbosity::Trace, category, msg, __VA_ARGS__)
#define SE_INFO(category, msg, ...)				Sphynx::Logging::Log(Sphynx::Logging::Verbosity::Info, category, msg, __VA_ARGS__)
#define SE_WARN(category, msg, ...)				Sphynx::Logging::Log(Sphynx::Logging::Verbosity::Warning, category, msg, __VA_ARGS__)
#define SE_ERR(category, msg, ...)				Sphynx::Logging::Log(Sphynx::Logging::Verbosity::Error, category, msg, __VA_ARGS__)
#define SE_FATAL(category, msg, ...) {																									\
	Sphynx::Logging::Log(Sphynx::Logging::Verbosity::Critical, category, msg, __VA_ARGS__);												\
